...
export default function DaftarMitraPage() {
  ...
  autoFocus 
/>
{/* Pesan error ditaruh di bawahnya: */}
{fieldErrors.nama_mitra && <p className="text-xs text-red-600 -mt-3 mb-3">{fieldErrors.nama_mitra}</p>}
...
/>
{/* Pesan error ditaruh di bawahnya: */}
{fieldErrors.nik_nib && <p className="text-xs text-red-600 -mt-3 mb-3">{fieldErrors.nik_nib}</p>}
                 ...
                 <FormField label="Detail Alamat" type="text" value={form.detail_alamat} onChange={(e) => update("detail_alamat", e.target.value.toUpperCase())} placeholder="Jalan, RT/RW, no. rumah, patokan" required />
